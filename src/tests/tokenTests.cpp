...
// 1 //
TEST("Should_get_type_for_number_token")
{
...
// 2 //
TEST("Should_get_type_for_operator_token")
{
...
// 3 //
TEST("Should_get_operator_code_from_operator_token")
{
...
// 4 //
TEST("Should_get_number_value_from_number_token")
{
